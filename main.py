...
def train(train_loader, tnet, criterion, optimizer, epoch):
    ...
    tnet.train()
    for batch_idx, (data1, data2, data3, c, img11, img111) in enumerate(train_loader):
        if args.cuda:
            data1, data2, data3, c, img11, img111 = data1.cuda(), data2.cuda(), data3.cuda(), c.cuda(), img11.cuda(), img111.cuda()
  
        # compute similarity
        sim_a, sim_b, sim_a11, sim_b11, sim_a111, sim_b111, sim_a1111, sim_b1111,sim_a11111, sim_b11111 = tnet(data1, data2, data3, c, img11, img111)
        ...
        loss_triplet = (criterion(sim_a, sim_b, target) + criterion(sim_a11, sim_b11, target) + criterion(sim_a111, sim_b111, target) + criterion(sim_a1111, sim_b1111, target) + criterion(sim_a11111, sim_b11111, target))/5.
        loss = loss_triplet
